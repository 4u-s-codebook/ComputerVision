...
def repulsion(rois, box_deltas, gt_rois, rois_inside_ws, rois_outside_ws):
    ...
    # if int(torch.sum(rois_outside_ws==rois_inside_ws))!=256: #1024:
    #     import pdb
    #     pdb.set_trace()
    ...
    print('In REPULSION LOSS : loss_repgt=',loss_repgt,'loss_repbox=',loss_repbox)
