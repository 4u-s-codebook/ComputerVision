...
from model.faster_rcnn.bbox_transform import bbox_transform_inv, bbox_overlaps
import math
from model.faster_rcnn.repulsion_loss import repulsion
...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        print('In Faster RCNN : ')
        # print(rois, cls_prob, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, RCNN_loss_repgt, RCNN_loss_repbox)
        #import pdb
        #pdb.set_trace()
